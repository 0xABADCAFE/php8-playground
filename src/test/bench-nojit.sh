...
time -v php -dopcache.jit_buffer_size=0 test_accumulate_method_call_direct_nonstrict.php
time -v php -dopcache.jit_buffer_size=0 test_accumulate_method_call_direct_strict.php
