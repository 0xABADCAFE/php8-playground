...
time -v php -dopcache.jit_buffer_size=1M -dopcache.jit=1255 test_accumulate_call_method_nonstrict.php
time -v php -dopcache.jit_buffer_size=1M -dopcache.jit=1255 test_accumulate_call_method_strict.php
time -v php -dopcache.jit_buffer_size=1M -dopcache.jit=1255 test_accumulate_call_closure_nonstrict.php
time -v php -dopcache.jit_buffer_size=1M -dopcache.jit=1255 test_accumulate_call_closure_strict.php
